...
export const useStudents = (page = 1, limit = 10, full_name?: string) => {
    return useQuery({
        queryKey: ['students', page, limit, full_name],
        queryFn: () => studentService.getStudents(page, limit, full_name),
